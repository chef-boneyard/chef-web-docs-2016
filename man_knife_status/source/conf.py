...
htmlhelp_basename = 'knife-status'
...
latex_documents = [
  ('index', 'knife-status.tex', u'knife-status',
...
man_pages = [
    ('index', 'knife-status', u'Man page for knife-status.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-status', u'knife-status',
   u'Opscode, Inc.', 'knife-status', 'knife-status',
   'Miscellaneous'),
]
