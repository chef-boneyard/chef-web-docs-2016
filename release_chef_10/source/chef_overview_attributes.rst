...
If we go back to the `overview of Chef <http://docs.getchef.com/chef_overview.html>`_, but then focus only on where attributes are located, it looks something like this:
