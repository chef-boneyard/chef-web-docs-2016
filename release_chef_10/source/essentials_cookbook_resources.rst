...
.. list-table::
   ...
   * - Common Item
     - Description
   * - `Actions <http://docs.getchef.com/release/10/resource_common.html#actions>`_
     - |resource short_actions|
   * - `Attributes <http://docs.getchef.com/release/10/resource_common.html#attributes>`_
     - |resource short_attributes|
   * - `Conditions <http://docs.getchef.com/release/10/resource_common.html#conditionals>`_
     - |resource short_conditions|
   * - `Notifications <http://docs.getchef.com/release/10/resource_common.html#notifications>`_
     - |resource short_notifications|
   * - `Relative Paths <http://docs.getchef.com/release/10/resource_common.html#relative-paths>`_
     - |resource short_relative_paths|
   * - `Windows File Security <http://docs.getchef.com/release/10/resource_common.html#windows-file-security>`_
     - |resource short_windows_file_security|
   * - `Run a Resource during Resource Compilation <http://docs.getchef.com/release/10/resource_common.html#run-from-resource-collection>`_
