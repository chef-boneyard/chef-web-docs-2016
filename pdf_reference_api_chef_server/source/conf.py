...
htmlhelp_basename = 'Chef Server API'
...
texinfo_documents = [
  ('index', 'Chef Server API', u'Chef Server API',
   u'Opscode, Inc.', 'Chef Server API', 'Chef Server API',
   'Miscellaneous'),
]
