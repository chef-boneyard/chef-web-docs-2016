...
htmlhelp_basename = 'knife-windows'
...
latex_documents = [
  ('index', 'knife-windows.tex', u'knife-windows',
...
man_pages = [
    ('index', 'knife-windows', u'Man page for knife-windows.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-windows', u'knife-windows',
   u'Opscode, Inc.', 'knife-windows', 'knife-windows',
   'Miscellaneous'),
]
