...
If we go back to the `overview of Chef <https://docs.chef.io/release/11-16/chef_overview.html>`_, but then focus only on where attributes are located, it looks something like this:
