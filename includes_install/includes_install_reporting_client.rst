...
This includes the run id of the run, which can be used in the `knife reporting plugin <http://docs.getchef.com/enterprise/plugin_knife_reporting.html>`_ or the management console to access the reporting information generated during the run.
