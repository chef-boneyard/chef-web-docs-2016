...
#. Configure |chef server 11| by running the following command:
   ...
   This command will set up all of the required components, including |erchef|, |rabbitmq|, |postgresql|, and the cookbooks the embedded version of |chef solo| used to maintain |chef server 11|.
