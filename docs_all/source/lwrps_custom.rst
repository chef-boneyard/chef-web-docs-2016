...
.. list-table::
   ...
   * - Topic
     - Description
   * - `Lightweight Resources <http://docs.getchef.com/lwrp_custom_resource.html>`_
     - A lightweight resource defines custom actions and attributes.
   * - `Lightweight Providers w/Chef Resources <http://docs.getchef.com/lwrp_custom_provider.html>`_
   ...
   * - `Lightweight Providers w/Custom Ruby <http://docs.getchef.com/lwrp_custom_provider_ruby.html>`_
