...
htmlhelp_basename = 'knife-environment'
...
latex_documents = [
  ('index', 'knife-environment.tex', u'knife-environment',
...
man_pages = [
    ('index', 'knife-environment', u'Man page for knife-environment.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-environment', u'knife-environment',
   u'Opscode, Inc.', 'knife-environment', 'knife-environment',
   'Miscellaneous'),
]
...
epub_title = u'knife-environment'
