...
latex_documents = [
  ('index', 'knife-ssh.tex', u'knife-ssh',
...
man_pages = [
    ('index', 'knife-ssh', u'Man page for knife-ssh.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-ssh', u'knife-ssh',
   u'Opscode, Inc.', 'knife-ssh', 'knife-ssh',
   'Miscellaneous'),
]
