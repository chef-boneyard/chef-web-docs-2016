...
htmlhelp_basename = 'knife-openstack'
...
latex_documents = [
  ('index', 'knife-openstack.tex', u'knife-openstack',
...
man_pages = [
    ('index', 'knife-openstack', u'Man page for knife-openstack.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-openstack', u'knife-openstack',
   u'Opscode, Inc.', 'knife-openstack', 'knife-openstack',
   'Miscellaneous'),
]
