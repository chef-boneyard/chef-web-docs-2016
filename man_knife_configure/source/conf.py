...
htmlhelp_basename = 'knife-configure'
...
latex_documents = [
  ('index', 'knife-configure.tex', u'knife-configure',
...
man_pages = [
    ('index', 'knife-configure', u'Man page for knife-configure.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-configure', u'knife-configure',
   u'Opscode, Inc.', 'knife-configure', 'knife-configure',
   'Miscellaneous'),
]
