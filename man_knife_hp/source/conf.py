...
man_pages = [
    ('index', 'knife-hp', u'Man page for knife-hp.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-hp', u'knife-hp',
   u'Opscode, Inc.', 'knife-hp', 'knife-hp',
   'Miscellaneous'),
]
