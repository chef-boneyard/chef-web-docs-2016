...
htmlhelp_basename = 'knife-search'
...
latex_documents = [
  ('index', 'knife-search.tex', u'knife-search',
...
man_pages = [
    ('index', 'knife-search', u'Man page for knife-search.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-search', u'knife-search',
   u'Opscode, Inc.', 'knife-search', 'knife-search',
   'Miscellaneous'),
]
