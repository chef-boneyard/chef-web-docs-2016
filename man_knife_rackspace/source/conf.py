...
htmlhelp_basename = 'knife-rackspace'
...
latex_documents = [
  ('index', 'knife-rackspace.tex', u'knife-rackspace',
...
man_pages = [
    ('index', 'knife-rackspace', u'Man page for knife-rackspace.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-rackspace', u'knife-rackspace',
   u'Opscode, Inc.', 'knife-rackspace', 'knife-rackspace',
   'Miscellaneous'),
]
