...
=====================================================
In the High Availability configuration, setup of |chef private| happens in two phases - the first phase configures |drbd|, and then pauses to allow you to finish establishing |drbd| replication before moving on:
...
Success!
=====================================================
Congratulations, |chef private| is installed in a High Availability configuration. Continue with the User Management section of this guide.
