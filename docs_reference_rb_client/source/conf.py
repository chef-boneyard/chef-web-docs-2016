...
latex_documents = [
  ('index', 'client_rb.tex', u'client.rb',
...
texinfo_documents = [
  ('index', 'client.rb', u'client.rb',
   u'Opscode, Inc.', 'client.rb', 'client.rb',
   'Miscellaneous'),
]
