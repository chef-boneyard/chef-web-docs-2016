...
.. note:: This set of topics is only about the |chef server osc| server. For information about the |chef client|, |ohai|, cookbooks, and so on, see |url docs|.
...
.. raw:: html
   ...
   &nbsp;&nbsp;&nbsp;   <a href="http://docs.getchef.com/release/osc_11-0/install_server.html">Install the Enterprise Chef Server</a> </br>
   &nbsp;&nbsp;&nbsp;   <a href="http://docs.getchef.com/release/osc_11-0/api_omnitruck.html">Download the chef-client using the Omnitruck API</a> </br>
...
.. raw:: html
   ...
   &nbsp;&nbsp;&nbsp;   <a href="http://docs.getchef.com/release/osc_11-0/api_chef_server.html">Chef Server API</a> </br>
