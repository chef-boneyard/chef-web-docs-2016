...
project = u'Chef 11.14.x Documentation'
...
html_title = "chef-client 11.14.x Documentation"
...
html_last_updated_fmt = 'chef-client, version 11.14.x'
...
htmlhelp_basename = 'chef-client 11.14.x Documentation'
