...
latex_documents = [
  ('index', 'knife-diff.tex', u'knife-diff',
...
man_pages = [
    ('index', 'knife-diff', u'Man page for knife-diff.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-diff', u'knife-diff',
   u'Opscode, Inc.', 'knife-diff', 'knife-diff',
   'Miscellaneous'),
]
