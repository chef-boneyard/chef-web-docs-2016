...
latex_documents = [
  ('index', 'knife-node.tex', u'knife-node',
...
man_pages = [
    ('index', 'knife-node', u'Man page for knife-node.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-node', u'knife-node',
   u'Opscode, Inc.', 'knife-node', 'knife-node',
   'Miscellaneous'),
]
