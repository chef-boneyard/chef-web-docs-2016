...
master_doc = 'ctl_chef_server'

# General information about the project.
project = u'chef-server-ctl Command Line Reference'
...
html_title = "chef-server-ctl Command Line Reference"
...
htmlhelp_basename = 'chef-server-ctl Command Line Reference'
...
latex_documents = [
  ('index', 'chef-server-ctl.tex', u'chef-server-ctl',
...
man_pages = [
    ('index', 'chef-server-ctl', u'chef-server-ctl',
     [u'Opscode, Inc.'], 1)
]
...
texinfo_documents = [
  ('index', 'chef-server-ctl', u'chef-server-ctl',
   u'Opscode, Inc.', 'chef-server-ctl', 'chef-server-ctl Command Line Reference',
   'Miscellaneous'),
]
...
epub_title = u'chef-server-ctl Command Line Reference'
