...
man_pages = [
    ('index', 'knife-user', u'Man page for knife-user.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-user', u'knife-user',
   u'Opscode, Inc.', 'knife-user', 'knife-user',
   'Miscellaneous'),
]
