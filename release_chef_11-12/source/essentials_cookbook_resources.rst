...
.. list-table::
   ...
   * - `Notifications <http://docs.opscode.com/release/11-12/resource_common.html#notifications>`_
     - |resource short_notifications|
   * - `Relative Paths <http://docs.opscode.com/release/11-12/resource_common.html#relative-paths>`_
     - |resource short_relative_paths|
   * - `Windows File Security <http://docs.opscode.com/release/11-12/resource_common.html#windows-file-security>`_
