...
latex_documents = [
  ('index', 'knife-exec.tex', u'knife-exec',
...
man_pages = [
    ('index', 'knife-exec', u'Man page for knife-exec.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-exec', u'knife-exec',
   u'Opscode, Inc.', 'knife-exec', 'knife-exec',
   'Miscellaneous'),
]
