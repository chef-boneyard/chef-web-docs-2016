...
.. list-table::
   ...
   * - ``actions['manage_endpoint']``
     - |manage_endpoint| If your |chef server oec| has a |chef manage| installation which is on a
       different port or host from the |api chef server|, specify the full URL to the root
       of the |chef manage| installation here, e.g. ``"http://manage.example.com:8080"``.
