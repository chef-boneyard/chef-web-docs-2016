...
master_doc = 'install_server'

# General information about the project.
project = u'Install Chef Server'
...
html_title = "Install Chef Server"
...
htmlhelp_basename = 'Install Chef Server'
...
latex_documents = [
  ('index', 'install_server.tex', u'Install Chef Server',
...
man_pages = [
    ('index', 'Install Chef Server', u'Install Chef Server',
     [u'Opscode, Inc.'], 1)
]
...
texinfo_documents = [
  ('index', 'Install Chef Server', u'Install Chef Server',
   u'Opscode, Inc.', 'Install Chef Server', 'Install Chef Server',
   'Miscellaneous'),
]
...
epub_title = u'Install Chef Server'
