...
latex_documents = [
  ('index', 'knife-azure.tex', u'knife-azure',
...
man_pages = [
    ('index', 'knife-azure', u'Man page for knife-azure.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-azure', u'knife-azure',
   u'Opscode, Inc.', 'knife-azure', 'knife-azure',
   'Miscellaneous'),
]
