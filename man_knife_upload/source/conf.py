...
htmlhelp_basename = 'knife-upload'
...
latex_documents = [
  ('index', 'knife-upload.tex', u'knife-upload',
...
man_pages = [
    ('index', 'knife-upload', u'Man page for knife-upload.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-upload', u'knife-upload',
   u'Opscode, Inc.', 'knife-upload', 'knife-upload',
   'Miscellaneous'),
]
