...
htmlhelp_basename = 'Knife Overview'
...
latex_documents = [
  ('index', 'Knife Overview.tex', u'Knife Overview',
...
man_pages = [
    ('index', 'Knife Overview', u'Man page for Knife Overview.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'Knife Overview', u'Knife Overview',
   u'Opscode, Inc.', 'Knife', 'Knife Overview',
   'Miscellaneous'),
]
