...
htmlhelp_basename = 'Environments'
...
latex_documents = [
  ('index', 'Environments.tex', u'Environments',
...
man_pages = [
    ('index', 'Environments', u'Environments',
     [u'Opscode, Inc.'], 1)
]
...
texinfo_documents = [
  ('index', 'Environments', u'Environments',
   u'Opscode, Inc.', 'Environments', 'Environments',
   'Miscellaneous'),
]
