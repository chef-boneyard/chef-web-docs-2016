...
latex_documents = [
  ('index', 'Repository.tex', u'Repository',
...
texinfo_documents = [
  ('index', 'Repository', u'Repository',
   u'Opscode, Inc.', 'Repository', 'Repository',
   'Miscellaneous'),
]
