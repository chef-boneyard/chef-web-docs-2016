...
master_doc = 'chef_server_api'

# General information about the project.
project = u'Chef Server API Documentation'
...
html_title = "Chef Server API Documentation"
...
htmlhelp_basename = 'Chef Server API Documentation'
...
latex_documents = [
  ('index', 'chef_server_api.tex', u'Chef Server API',
...
man_pages = [
    ('index', 'Chef Server API', u'Chef Server API',
     [u'Opscode, Inc.'], 1)
]
...
texinfo_documents = [
  ('index', 'Chef Server API', u'Chef Server API',
   u'Opscode, Inc.', 'Chef Server API', 'Documentation for the Chef Server API.',
   'Miscellaneous'),
]
...
epub_title = u'Chef Server API Documentation'
