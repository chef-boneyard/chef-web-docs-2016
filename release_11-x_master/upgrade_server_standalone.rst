...
.. Please `view the notes <http://docs.getchef.com/upgrade_server_standalone_notes.html>`_ about the standalone |chef server oec| upgrade for any changes that may exist for your upgrade process.
