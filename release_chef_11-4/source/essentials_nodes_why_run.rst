...
For a detailed explanation of the dry-run concept and how it relates to the |whyrun| mode in |chef|, see `this blog post <http://blog.afistfulofservers.net/post/2012/12/21/promises-lies-and-dryrun-mode/>`_.
