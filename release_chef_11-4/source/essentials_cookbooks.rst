...
.. list-table::
   ...
   * - Components
     - Description
   * - :doc:`Chef Cookbooks </opscode_cookbooks>`
   ...
   * - :doc:`Resources and Providers </essentials_cookbook_resources>`
     - A resource is a package, a service, a group of users, and so on. A resource tells the |chef client| which provider to use during a |chef client| run for various tasks like installing packages, running |ruby| code, or accessing directories and file systems. The resource is generic: "install program A" while the provider knows what to do with that process on |debian| and |ubuntu| and |windows|. A provider defines the steps that are required to bring that piece of the system into the desired state. Default providers cover all of the most common scenarios.
