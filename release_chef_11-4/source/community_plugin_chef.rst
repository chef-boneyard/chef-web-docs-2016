...
.. list-table::
   ...
   * - chef-handler-twitter
     - Adds a handler that tweets. Download this plugin: https://github.com/dje/chef-handler-twitter.
   * - chef-handler-librato
     - Adds a handler that sends metrics to |librato|. Download this plugin: https://github.com/bscott/chef-handler-librato.
   * - chef-hatch-repo
   ...
   * - chef-vpc-toolkit
     - Adds a set of |rake| tasks that provide a framework that helps automate the creation and configuration of identical virtual server groups in the cloud. Download this plugin: https://github.com/rackspace/chef_vpc_toolkit.
   * - ironfan
