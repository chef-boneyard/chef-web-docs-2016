...
html_title = "Chef 11.0.0 > 11.4.0 Documentation"
...
htmlhelp_basename = 'Chef 11.0.0 > 11.4.0 Documentation'
...
latex_documents = [
  ('index', 'Chef 11.0.0 > 11.4.0 Documentation.tex', u'Chef 11.0.0 > 11.4.0 Documentation',
...
man_pages = [
    ('index', 'Chef 11.0.0 > 11.4.0 Documentation', u'Chef 11.0.0 > 11.4.0 Documentation',
     [u'Opscode, Inc.'], 1)
]
...
texinfo_documents = [
  ('index', 'Chef 11.0.0 > 11.4.0 Documentation', u'Chef 11.0.0 > 11.4.0 Documentation',
   u'Opscode, Inc.', 'Chef 11.0.0 > 11.4.0 Documentation', 'Chef 11.0.0 > 11.4.0 Documentation',
   'Miscellaneous'),
]
...
epub_title = u'Chef 11.0.0 > 11.4.0 Documentation'
epub_author = u'Opscode, Inc.'
epub_publisher = u'Opscode, Inc.'
epub_copyright = u'2013, Opscode, Inc.'
