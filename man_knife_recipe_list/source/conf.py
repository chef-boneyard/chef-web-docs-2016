...
htmlhelp_basename = 'knife-recipe-list'
...
latex_documents = [
  ('index', 'knife-recipe-list.tex', u'knife-recipe-list',
...
man_pages = [
    ('index', 'knife-recipe-list', u'Man page for knife-recipe-list.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-recipe-list', u'knife-recipe-list',
   u'Opscode, Inc.', 'knife-recipe-list', 'knife-recipe-list',
   'Miscellaneous'),
]
...
epub_title = u'knife-recipe-list'
