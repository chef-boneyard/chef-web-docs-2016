...
htmlhelp_basename = 'knife-bootstrap'
...
latex_documents = [
  ('index', 'knife-bootstrap.tex', u'knife-bootstrap',
...
man_pages = [
    ('index', 'knife-bootstrap', u'Man page for knife-bootstrap.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-bootstrap', u'knife-bootstrap',
   u'Opscode, Inc.', 'knife-bootstrap', 'knife-bootstrap',
   'Miscellaneous'),
]
