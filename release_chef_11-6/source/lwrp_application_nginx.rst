=====================================================
application_nginx Lightweight Resource
=====================================================
...
The |cookbook application_nginx| cookbook contains the following lightweight resource: ``application_nginx_load_balancer``.
