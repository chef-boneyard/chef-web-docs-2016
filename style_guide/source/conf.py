...
latex_documents = [
  ('index', 'Style Guide.tex', u'Style Guide',
...
man_pages = [
    ('index', 'Style Guide', u'Style Guide',
     [u'Opscode, Inc.'], 1)
]
...
texinfo_documents = [
  ('index', 'Style Guide', u'Style Guide',
   u'Opscode, Inc.', 'Style Guide', 'Style Guide',
   'Miscellaneous'),
]
