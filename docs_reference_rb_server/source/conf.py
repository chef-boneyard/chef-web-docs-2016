...
latex_documents = [
  ('index', 'server_rb.tex', u'server.rb',
...
texinfo_documents = [
  ('index', 'server.rb', u'server.rb',
   u'Opscode, Inc.', 'server.rb', 'server.rb',
   'Miscellaneous'),
]
