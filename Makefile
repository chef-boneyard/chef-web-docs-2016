...
release: master all client

#
# OTHER BUILDS -- REMOVED FOR THE MOMENT AND ONLY REBUILD AD HOC
# 
#  enterprise open_source  devkit server 11-10 11-12 ohai-7 osc_11-0 osc_11-1 10 11-0 11-2 11-4 11-6 11-8 oec_11-0 oec_11-1 ohai-6
#  
# 
#
# 
