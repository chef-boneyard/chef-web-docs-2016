...
release: master server 12-0 11-0 11-2 11-4 11-6 11-8 11-10 11-12 11-14 11-16 enterprise oec_11-0 oec_11-1 oec_11-2 client devkit ohai-7 ohai-6 open_source osc_11-0 osc_11-1 10 private_chef
...
11-16:
	...
	sphinx-build release_chef_11-16/source $(BUILDDIR)/release/11-16/

12-0:
	mkdir -p $(BUILDDIR)/release/12-0/
	sphinx-build release_chef_12-0/source $(BUILDDIR)/release/12-0/
...
oec_11-2:
	...
	sphinx-build release_oec_11-2/source $(BUILDDIR)/release/oec_11-2/
...
private_chef:
	...
	sphinx-build release_private_chef/source $(BUILDDIR)/release/private_chef/
