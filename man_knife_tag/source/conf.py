...
latex_documents = [
  ('index', 'knife-tag.tex', u'knife-tag',
...
man_pages = [
    ('index', 'knife-tag', u'Man page for knife-tag.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-tag', u'knife-tag',
   u'Opscode, Inc.', 'knife-tag', 'knife-tag',
   'Miscellaneous'),
]
