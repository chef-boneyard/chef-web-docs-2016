...
htmlhelp_basename = 'knife-bluelock'
...
latex_documents = [
  ('index', 'knife-bluelock.tex', u'knife-bluelock',
...
man_pages = [
    ('index', 'knife-bluelock', u'Man page for knife-bluelock.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-bluelock', u'knife-bluelock',
   u'Opscode, Inc.', 'knife-bluelock', 'knife-bluelock',
   'Miscellaneous'),
]
