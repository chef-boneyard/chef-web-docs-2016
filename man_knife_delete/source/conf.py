...
htmlhelp_basename = 'knife-delete'
...
latex_documents = [
  ('index', 'knife-delete.tex', u'knife-delete',
...
man_pages = [
    ('index', 'knife-delete', u'Man page for knife-delete.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-delete', u'knife-delete',
   u'Opscode, Inc.', 'knife-delete', 'knife-delete',
   'Miscellaneous'),
]
