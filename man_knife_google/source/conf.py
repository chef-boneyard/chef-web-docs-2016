...
htmlhelp_basename = 'knife-google'
...
latex_documents = [
  ('index', 'knife-google.tex', u'knife-google',
...
man_pages = [
    ('index', 'knife-google', u'Man page for knife-google.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-google', u'knife-google',
   u'Opscode, Inc.', 'knife-google', 'knife-google',
   'Miscellaneous'),
]
