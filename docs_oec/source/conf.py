...
latex_documents = [
  ('index', 'Enterprise Chef.tex', u'Enterprise Chef',
...
man_pages = [
    ('index', 'Enterprise Chef', u'Enterprise Chef',
     [u'Opscode, Inc.'], 1)
]
...
texinfo_documents = [
  ('index', 'Enterprise Chef', u'Enterprise Chef',
   u'Opscode, Inc.', 'Enterprise Chef', 'Enterprise Chef',
   'Miscellaneous'),
]
