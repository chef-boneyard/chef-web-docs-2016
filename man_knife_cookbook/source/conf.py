...
htmlhelp_basename = 'knife-cookbook'
...
latex_documents = [
  ('index', 'knife-cookbook.tex', u'knife-cookbook',
...
man_pages = [
    ('index', 'knife-cookbook', u'Man page for knife-cookbook.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-cookbook', u'knife-cookbook',
   u'Opscode, Inc.', 'knife-cookbook', 'knife-cookbook',
   'Miscellaneous'),
]
