...
htmlhelp_basename = 'knife-bluebox'
...
latex_documents = [
  ('index', 'knife-bluebox.tex', u'knife-bluebox',
...
man_pages = [
    ('index', 'knife-bluebox', u'Man page for knife-bluebox.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-bluebox', u'knife-bluebox',
   u'Opscode, Inc.', 'knife-bluebox', 'knife-bluebox',
   'Miscellaneous'),
]
