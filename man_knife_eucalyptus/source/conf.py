...
htmlhelp_basename = 'knife-eucalyptus'
...
latex_documents = [
  ('index', 'knife-eucalyptus.tex', u'knife-eucalyptus',
...
man_pages = [
    ('index', 'knife-eucalyptus', u'Man page for knife-eucalyptus.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-eucalyptus', u'knife-eucalyptus',
   u'Opscode, Inc.', 'knife-eucalyptus', 'knife-eucalyptus',
   'Miscellaneous'),
]
