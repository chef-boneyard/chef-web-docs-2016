...
latex_documents = [
  ('index', 'knife-list.tex', u'knife-list',
...
man_pages = [
    ('index', 'knife-list', u'Man page for knife-list.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-list', u'knife-list',
   u'Opscode, Inc.', 'knife-list', 'knife-list',
   'Miscellaneous'),
]
