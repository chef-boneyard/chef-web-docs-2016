...
htmlhelp_basename = 'knife-essentials'
...
latex_documents = [
  ('index', 'knife-essentials.tex', u'knife-essentials',
...
man_pages = [
    ('index', 'knife-essentials', u'knife-essentials',
     [u'Opscode, Inc.'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-essentials', u'knife-essentials',
   u'Opscode, Inc.', 'knife-essentials', 'knife-essentials',
   'Miscellaneous'),
]
