...
htmlhelp_basename = 'knife-data-bag'
...
man_pages = [
    ('index', 'knife-data-bag', u'Man page for knife-data-bag.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-data-bag', u'knife-data-bag',
   u'Opscode, Inc.', 'knife-data-bag', 'knife-data-bag',
   'Miscellaneous'),
]
