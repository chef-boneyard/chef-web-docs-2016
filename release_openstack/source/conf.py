...
html_last_updated_fmt = 'current versions of Chef for OpenStack'
...
htmlhelp_basename = 'Chef for OpenStack'
...
latex_documents = [
  ('index', 'Chef for OpenStack.tex', u'Chef for OpenStack',
   u'Chef', 'manual'),
]
