...
master_doc = 'manage_server_open_source'

# General information about the project.
project = u'Manage the Open Source Chef Server'
...
html_title = "Manage the Open Source Chef Server"
...
htmlhelp_basename = 'Manage the Open Source Chef Server'
...
latex_documents = [
  ('index', 'manage_open_source_chef_server.tex', u'Manage the Open Source Chef Server',
...
man_pages = [
    ('index', 'Manage the Open Source Chef Server', u'Manage the Open Source Chef Server',
     [u'Opscode, Inc.'], 1)
]
...
texinfo_documents = [
  ('index', 'Manage the Open Source Chef Server', u'Manage the Open Source Chef Server',
   u'Opscode, Inc.', 'Manage the Open Source Chef Server', 'Manage the Open Source Chef Server',
   'Miscellaneous'),
]
...
epub_title = u'Manage the Open Source Chef Server'
