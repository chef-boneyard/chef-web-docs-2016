...
The |subcommand knife ssl_check| subcommand is used to verify the SSL configuration for the |chef server| or at another location specified by a URL or URI.
