...
htmlhelp_basename = 'knife-linode'
...
latex_documents = [
  ('index', 'knife-linode.tex', u'knife-linode',
...
man_pages = [
    ('index', 'knife-linode', u'Man page for knife-linode.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-linode', u'knife-linode',
   u'Opscode, Inc.', 'knife-linode', 'knife-linode',
   'Miscellaneous'),
]
