...
latex_documents = [
  ('index', 'knife-role.tex', u'knife-role',
...
man_pages = [
    ('index', 'knife-role', u'Man page for knife-role.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-role', u'knife-role',
   u'Opscode, Inc.', 'knife-role', 'knife-role',
   'Miscellaneous'),
]
