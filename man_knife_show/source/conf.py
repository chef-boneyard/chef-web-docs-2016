...
latex_documents = [
  ('index', 'knife-show.tex', u'knife-show',
...
man_pages = [
    ('index', 'knife-show', u'Man page for knife-show.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-show', u'knife-show',
   u'Opscode, Inc.', 'knife-show', 'knife-show',
   'Miscellaneous'),
]
