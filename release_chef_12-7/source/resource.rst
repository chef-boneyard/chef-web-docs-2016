...
.. list-table::
   ...
   * - Common Item
     - Description
   * - `Actions <https://docs.chef.io/release/12-7/resource_common.html#actions>`_
     - |resource short_actions|
   * - `Properties <https://docs.chef.io/release/12-7/resource_common.html#attributes>`_
     - |resource short_attributes|
   * - `Guards <https://docs.chef.io/release/12-7/resource_common.html#conditionals>`_
     - |resource short_conditions|
   * - `Notifications <https://docs.chef.io/release/12-7/resource_common.html#notifications>`_
     - |resource short_notifications|
   * - `Relative Paths <https://docs.chef.io/release/12-7/resource_common.html#relative-paths>`_
     - |resource short_relative_paths|
   * - `Windows File Security <https://docs.chef.io/release/12-7/resource_common.html#windows-file-security>`_
     - |resource short_windows_file_security|
   * - `Run a Resource during Resource Compilation <http://docs.opscode.com/release/12-7/resource_common.html#run-from-resource-collection>`_
