...
latex_documents = [
  ('index', 'metadata_rb.tex', u'metadata.rb',
...
man_pages = [
    ('index', 'metadata_rb', u'metadata.rb',
     [u'Opscode, Inc.'], 1)
]
...
texinfo_documents = [
  ('index', 'metadata.rb', u'metadata.rb',
   u'Opscode, Inc.', 'metadata.rb', 'metadata.rb',
   'Miscellaneous'),
]
