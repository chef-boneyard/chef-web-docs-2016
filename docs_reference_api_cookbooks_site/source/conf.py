...
htmlhelp_basename = 'Cookbooks Site API'
...
texinfo_documents = [
  ('index', 'Cookbooks Site API', u'Cookbooks Site API',
   u'Opscode, Inc.', 'Cookbooks Site API', 'Cookbooks Site API',
   'Miscellaneous'),
]
...
epub_title = u'Cookbooks Site API'
