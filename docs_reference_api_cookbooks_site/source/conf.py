...
master_doc = 'cookbooks_site_api'

# General information about the project.
project = u'Cookbooks Site API Documentation'
...
html_title = "Cookbooks Site API Documentation"
...
htmlhelp_basename = 'Cookbooks Site API Documentation'
...
latex_documents = [
  ('index', 'cookbooks_site_api.tex', u'Cookbooks Site API',
...
man_pages = [
    ('index', 'Cookbooks Site API', u'Cookbooks Site API',
     [u'Opscode, Inc.'], 1)
]
...
texinfo_documents = [
  ('index', 'Cookbooks Site API', u'Cookbooks Site API',
   u'Opscode, Inc.', 'Cookbooks Site API', 'Documentation for the Cookbooks Site API.',
   'Miscellaneous'),
]
...
epub_title = u'Cookbooks Site API Documentation'
