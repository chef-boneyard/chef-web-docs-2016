...
latex_documents = [
  ('index', 'knife-raw.tex', u'knife-raw',
...
man_pages = [
    ('index', 'knife-raw', u'Man page for knife-raw.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-raw', u'knife-raw',
   u'Opscode, Inc.', 'knife-raw', 'knife-raw',
   'Miscellaneous'),
]
