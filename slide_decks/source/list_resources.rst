...
.. revealjs::
 ...
 .. revealjs:: 2. template
    ...
    Use the `template resource <http://docs.chef.io/resource_template.html>`__ to build a file on a node that is based on a template located in a cookbook. |chef| uses |erb| templates and |ruby| expressions to define a template file.
 ...
 .. revealjs:: 9. bash
    ...
    Use the `bash resource <http://docs.chef.io/resource_bash.html>`__ to run a script on a node. There are |resource script| resources for |bash|, |csh|, |perl|, |python|, |ruby|, and |windows powershell|.
