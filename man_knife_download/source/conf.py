...
htmlhelp_basename = 'knife-download'
...
latex_documents = [
  ('index', 'knife-download.tex', u'knife-download',
...
man_pages = [
    ('index', 'knife-download', u'Man page for knife-download.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-download', u'knife-download',
   u'Opscode, Inc.', 'knife-download', 'knife-download',
   'Miscellaneous'),
]
