...
htmlhelp_basename = 'knife-client'
...
latex_documents = [
  ('index', 'knife-client.tex', u'knife-client',
...
man_pages = [
    ('index', 'knife-client', u'Man page for knife-client.',
     [u'Opscode'], 1)
]
...
texinfo_documents = [
  ('index', 'knife-client', u'knife-client',
   u'Opscode, Inc.', 'knife-client', 'knife-client',
   'Miscellaneous'),
]
