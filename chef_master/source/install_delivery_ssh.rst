...
* Install using |amazon aws|. This method of provisioning takes care of creating most of the resources you need for |chef delivery|, and setting them up. For details on using AWS provisioning, see :ref:`install_delivery_aws`.
