...
This reference contains examples for the resources available to the |chef client|, sorted by resource. This topic is a subset of the topic that contains a `complete description of all resources <http://docs.opscode.com/chef/resources.html>`_, including actions, attributes, and providers (in addition to these examples).
