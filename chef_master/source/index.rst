...
**Docs for Current Versions:** `chef-client <http://docs.chef.io/client/>`__ | `Chef Server <http://docs.chef.io/server/>`_ | `Chef DK <http://docs.chef.io/devkit/>`__ | `Ohai 7 <http://docs.chef.io/release/ohai-7/>`_ | :doc:`Release notes for chef-client 12.0 </release_notes>` | `Release notes for Chef server 12 <http://docs.chef.io/server/release_notes.html>`_ | :doc:`Previous Releases </releases>`
...
* All data that is stored on the |chef server|---including everything uploaded to the server from the |chef repo| and by the |chef client|---is :doc:`searchable </chef_search>` from both recipes (using the `search method <http://docs.chef.io/dsl_recipe.html#search>` in the |dsl recipe|) and the workstation (using the :doc:`knife search </knife_search>` subcommand)
...
The Nodes
=====================================================
**The Basics:** :doc:`About Nodes </nodes>` | :doc:`chef-client (agent) </chef_client>` | `The chef-client Run <http://docs.chef.io/chef_client.html#the-chef-client-title-run>`_ | :doc:`Chef Solo </chef_solo>` | :doc:`Debug Recipes </chef_shell>` | :doc:`Chef for Containers </containers>` | :doc:`Chef for Junos OS </junos>`
