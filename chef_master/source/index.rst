...
**Docs for Current Versions:** `chef-client <http://docs.opscode.com/client/>`__ | `Open Source Chef Server <http://docs.opscode.com/open_source/>`_ | `Enterprise Chef Server <http://docs.opscode.com/enterprise/>`_ | :doc:`Ohai 7 </ohai>` | :doc:`Release Notes for 11.8 </release_notes>`
