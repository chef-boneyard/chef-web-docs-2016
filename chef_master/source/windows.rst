...
* A resource named |resource dsc_resource| is in development---available for preview via the https://github.com/chef-cookbooks/dsc cookbook---that adds the ability to use Powershell DSC resources in Chef!
